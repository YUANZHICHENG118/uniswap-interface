    ...
    <TeamRuleWrap className="bgwrap team-item">
      <div className="header">
        ...
        <div className="row remark no-gutters">
          <div className="col-lg-3 col-xs-12 mb-1">
            最多邀请 <span className="themeColor">3</span>名组员入团
          </div>
          <div className="col-lg-6 col-xs-12 mb-1">
            团队总认购大于 <span className="themeColor">3000 USDT</span> ,即可获取相应的团队收益奖励
          </div>
          <div className="col-lg-3 col-xs-12 mb-1">团队奖励=团队总认购*团队收益率</div>
        </div>
        <SubscriptionWrap className="subscription mt-5">
          ...
          <div className="middle row align-items-center">
            <h5 className="col-lg-2 mt-3 mb-0">
              <b className="themeColor">实时团队总认购</b>
            </h5>
