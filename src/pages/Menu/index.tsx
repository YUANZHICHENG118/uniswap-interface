                ...
                <RowItemBox>
                  <FlexCenter>
                    ...
                    <RowItemButton color="#d16c00" font-size="16">
                      {
                        item.available?<a className="sc-AxirZ kRQAGp" href={item.lp?`/#/Farm/${item.symbol}`:item.tokenSymbol!="PZS"?`/#/Farm/token/${item.symbol}`:!item.tag?`/#/Farm/pzs/${item.symbol}`:`/#/Farm/pzss/${item.symbol}`}>
                          Select
